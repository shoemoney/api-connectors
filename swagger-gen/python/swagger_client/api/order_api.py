...
class OrderApi(object):
    ...
    def order_replace(self, order_id, symbol, **kwargs):  # noqa: E501
        """Replace active order. Only incomplete orders can be modified.   # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.order_replace(order_id, symbol, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.order_replace_with_http_info(order_id, symbol, **kwargs)  # noqa: E501
        else:
            (data) = self.order_replace_with_http_info(order_id, symbol, **kwargs)  # noqa: E501
            return data

    def order_replace_with_http_info(self, order_id, symbol, **kwargs):  # noqa: E501
        """Replace active order. Only incomplete orders can be modified.   # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.order_replace_with_http_info(order_id, symbol, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['order_id', 'symbol', 'p_r_qty', 'p_r_price']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('order_id' not in params or
                params['order_id'] is None):
            raise ValueError("Missing the required parameter `order_id` when calling `order_replace`")  # noqa: E501
        # verify the required parameter 'symbol' is set
        if ('symbol' not in params or
                params['symbol'] is None):
